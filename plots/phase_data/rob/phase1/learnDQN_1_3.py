...
if __name__ == "__main__":
  ...
  filename = "segmentation_bs"+str(BATCH_SIZE)+"_ss" + str(STACK_SIZE) + "_rb" + str(options.replay_buffer)+"_gamma"+str(GAMMA)+"_decaylf"+str(EPS_DECAY_LAST_FRAME)+"_lr"+str(LEARNING_RATE)
